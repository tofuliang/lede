...
sed -i "s/1.2019.28/2020.33/g" smartdns/Makefile
sed -i 's/982002e836e486fb4e360bc10e84e7e7197caf46/86902d2e3415666246dae0286262e43923f58532/g' smartdns/Makefile
...
rm -f ./.config*
cp homerouter.config ./.config
sed -i 's/^[ \t]*//g' ./.config

make defconfig
make download -j8

(cd feeds/luci;patch -p1 < ../../luci.patch)
