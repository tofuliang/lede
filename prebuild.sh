...
sed -i "s/1.2019.28/2022.36.1/g" smartdns/Makefile
...
sed -i '/PREROUTING/d; /udp/d; s/ -p tcp --dport 53//g' feeds/luci/applications/luci-app-accesscontrol/root/etc/init.d/mia